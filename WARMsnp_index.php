...
<div class="w3-top">
  <div class="w3-bar navbar navbar-dark bg-dark" id="myNavbar">
    ...
    <a href="WARMsnp_home.php" class="w3-bar-item w3-button">
...
<div class="w3-display-container w3-animate-opacity" id="home">
 ...
 <div class="w3-display-middle" style="white-space:nowrap;">
    <a href="WARMsnp_home.php"><span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity"><span class="w3-hide-small">WARM</span>snp</span></a>
  </div>
</div>
...
<div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      ...
      <div class="w3-half">
        <img src="images/Snps_genes.png" style="width:100%" alt="Top Genes - SNPs ratio">
      </div>
    </div>
</div>
...
<div class="row">
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <p class="title">Web server/database designer</p>
        <p>In a relationship with GIT</p>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2>Ramon Massoni</h2>
        <p class="title">Data visualization expert</p>
        <p>Juggle for life</p>
  ...
  <div class="column">
    <div class="card">
      <img src="https://media.giphy.com/media/26xBKlTBLN10xp7oc/giphy.gif" alt="Wini" style="width:100%">
      <div class="container">
