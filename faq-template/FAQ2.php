...
<section class="cd-faq" style="margin-top:10px;">
	...
	<div class="cd-faq-items">
		<ul id="basics" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">What is a SNP?</a>
			...
			<li>
				<a class="cd-faq-trigger" href="#0">What is the role of genomic variation in cardiovascular disease development?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">What is the p-value?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">What is the Beta value?</a>
				<div class="cd-faq-content">
		...
		<ul id="formats" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">What input formats does WARM-snp support?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">How do I upload files?</a>
				<div class="cd-faq-content">
		...
		<ul id="results" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">What tools does WARM-snp provide to interpret and visualize the effect of a particular SNP on CD?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">What data does WARM-snp provide for a particular SNP besides the p-value, beta value and genomic coordinate?</a>
				<div class="cd-faq-content">
